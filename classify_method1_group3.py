...
def face_crop_resize(image, faces):
    for i in range(len(faces)):
        ...
        if max_len >= 250:
            save_folder = f"./face_result/method1_group3/folder1/{split_folder_num}/"
            image_and_txt(save_folder, image_cropped_resized, i)
        elif max_len >= 200:
            save_folder = f"./face_result/method1_group3/folder2/{split_folder_num}/"
            image_and_txt(save_folder, image_cropped_resized, i)
        elif max_len >= 150:
            save_folder = f"./face_result/method1_group3/folder3/{split_folder_num}/"
            image_and_txt(save_folder, image_cropped_resized, i)
        else:
            save_folder = "./face_result/method1_group3/others"            
...
if __name__ == "__main__":
    ...
    folder_remove_make("./face_result/method1_group3/folder1")
    folder_remove_make("./face_result/method1_group3/folder2")
    folder_remove_make("./face_result/method1_group3/folder3")
    folder_remove_make("./face_result/method1_group3/group1")
    folder_remove_make("./face_result/method1_group3/group2")
    folder_remove_make("./face_result/method1_group3/group3")
    ...
    base_dir = "./face_result/method1_group3"
    for dirs in os.listdir(base_dir)[:3]:
    ...
    print(f"method1_group3 crop_resize execution time : {(crop_resize_end - entire_start - metadata_load_time) :.2f}s")
    
    copy_start = time.time()
    
    #각 folder에서 group으로 복사
    shutil.copytree("./face_result/method1_group3/folder1", "./face_result/method1_group3/group1/folder1")
    shutil.copytree("./face_result/method1_group3/folder1", "./face_result/method1_group3/group2/folder1")
    shutil.copytree("./face_result/method1_group3/folder1", "./face_result/method1_group3/group3/folder1")
    shutil.copytree("./face_result/method1_group3/folder2", "./face_result/method1_group3/group2/folder2")
    shutil.copytree("./face_result/method1_group3/folder2", "./face_result/method1_group3/group3/folder2")
    shutil.copytree("./face_result/method1_group3/folder3", "./face_result/method1_group3/group3/folder3")
    
    copy_end = time.time()
    print(f"method1_group3 copy execution time : {copy_end - copy_start :.2f}s")
    print(f"method1_group3 pure execution time : {(copy_end - entire_start - metadata_load_time) :.2f}s")
    print(f"method1_group3 total execution time : {copy_end - entire_start:.2f}s")
    print(f"method1_group3 Predicted time for full dataset : {(copy_end - entire_start - metadata_load_time)*(153/f_num)*(6700/j_num):.2f}s")
